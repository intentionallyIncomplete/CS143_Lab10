...
public class CharTree {
	 ...
	 * @param subTreeRoot
	 * 
	 * @return - Returns the root node of a tree that is the tree with root node
	 ...
	 * @param item
	 * @param subTreeRoot
	 * @return - Makes two recursive calls with a base case that the subtree root is null (end of tree).
	 */
